...
First off, thank you for considering contributing to **spaceporn-doc**.
...
If you think there are a good reason to open an issue for **spaceporn-doc**,
you should. Here some of these reasons (but there are many more):
1. A fix. As mentioned in this [README](README.md), the author is not a pro
