...
`v` value is in:
- the ![](https://latex.codecogs.com/svg.image?[0.0;&space;0.25[) interval, this formula will return `0.0`,
- the ![](https://latex.codecogs.com/svg.image?[0.25;&space;0.5[) interval, this formula will return `0.25`,
- the ![](https://latex.codecogs.com/svg.image?[0.5;&space;0.75[) interval, this formula will return `0.5`,
- the ![](https://latex.codecogs.com/svg.image?[0.75;&space;1.0[) interval, this formula will return `0.75`,
