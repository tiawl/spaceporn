...
pub const CompileOptions = struct {
    ...
    pub fn setVulkanVersion(self: @This(), env_version: shaderc.Env.VulkanVersion) void {
        c.shaderc_compile_options_set_target_env(self.handle, @intFromEnum(shaderc.Env.Target.Vulkan), @intFromEnum(env_version));
    }
};
