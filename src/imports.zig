...
// Values from https://developer.mozilla.org/en-US/docs/Web/API/WheelEvent/deltaMode
pub const PlatformDeltaMode = enum(js.Uint32) {
    pixel = 0x00,
    line = 0x01,
    page = 0x02,
};
...
pub extern "env" fn jsGpuDeviceCreatePipelineLayout(js.Handle, js.OpaquePtr, js.Uint32) js.Handle;
pub extern "env" fn jsGpuDeviceCreateRenderPipeline(js.Handle, js.Handle, js.OpaquePtr, js.OpaquePtr, js.OpaquePtr) js.Handle;
pub extern "env" fn jsGpuDeviceCreateCommandEncoder(js.Handle) js.Handle;
pub extern "env" fn jsGpuDeviceCreateTexture(js.Handle, js.OpaquePtr) js.Handle;
...
pub extern "env" fn jsGpuDeviceCreateBindGroup(js.Handle, js.Handle, js.OpaquePtr, js.Uint32) js.Handle;
pub extern "env" fn jsGpuDeviceCreateBindGroupLayout(js.Handle, js.OpaquePtr, js.Uint32) js.Handle;
pub extern "env" fn jsGpuDeviceCreateSampler(js.Handle, js.OpaquePtr) js.Handle;
...
pub extern "env" fn jsGpuTextureCreateView(js.Handle, js.OpaquePtr) js.Handle;
pub extern "env" fn jsGpuCommandEncoderBeginRenderPass(js.Handle, js.Handle, js.OpaquePtr) js.Handle;
...
pub extern "env" fn jsGpuRenderPassEncoderSetBindGroup(js.Handle, js.Uint32, js.Handle, js.OpaquePtr, js.Uint32) void;
...
pub extern "env" fn jsGpuRenderPassEncoderSetBlendConstant(js.Handle, js.OpaquePtr) void;
...
pub extern "env" fn jsGpuQueueSubmit(js.Handle, js.OpaquePtr, js.Uint32) void;
...
pub extern "env" fn jsPlatformWindowKeyboardEventGetCodepoint(js.Handle) js.Uint32;
pub extern "env" fn jsPlatformWindowGetDevicePixelRatio(js.Handle) js.Float32;
pub extern "env" fn jsPlatformCanvasGetBoundingClientRectWidth(js.Handle) js.Uint32;
pub extern "env" fn jsPlatformCanvasGetBoundingClientRectHeight(js.Handle) js.Uint32;
pub extern "env" fn jsPlatformCanvasGetBoundingClientRectLeft(js.Handle) js.Uint32;
pub extern "env" fn jsPlatformCanvasGetBoundingClientRectTop(js.Handle) js.Uint32;
pub extern "env" fn jsPlatformCanvasGetGpuContext(js.Handle) js.Handle;
pub extern "env" fn jsPlatformCanvasResize(js.Handle, js.Uint32, js.Uint32) void;
pub extern "env" fn jsPlatformCanvasListenEvent(js.Handle, js.StringPtr, js.Uint32) void;
pub extern "env" fn jsPlatformCanvasMouseButtonEventGetButton(js.Handle) js.Uint32;
pub extern "env" fn jsPlatformCanvasMouseMoveEventGetClientX(js.Handle) js.Uint32;
pub extern "env" fn jsPlatformCanvasMouseMoveEventGetClientY(js.Handle) js.Uint32;
pub extern "env" fn jsPlatformCanvasWheelEventGetDeltaMode(js.Handle) js.PlatformDeltaMode;
pub extern "env" fn jsPlatformCanvasWheelEventGetDeltaX(js.Handle) js.Float32;
pub extern "env" fn jsPlatformCanvasWheelEventGetDeltaY(js.Handle) js.Float32;
