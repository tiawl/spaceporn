...
pub const DrawData = struct {
    pub const Ex = struct {
        pub fn render(draw_data: *c.ImDrawData, command_buffer: vk.Command.Buffer, pipeline: vk.Pipeline) void {
...
fn loader(function_name: [*c]const u8, instance: ?*anyopaque) callconv(c.call_conv) ?*const fn () callconv(c.call_conv) void {
