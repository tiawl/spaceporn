...
pub const Descriptor = extern struct {
    ...
    pub const Pool = enum(u64) {
        ...
        pub fn create(device: vk.Device, p_create_info: *const vk.Descriptor.Pool.Create.Info) !@This() {
    ...
    pub const Set = enum(u64) {
        ...
        pub const Layout = enum(u64) {
            ...
            pub fn create(device: vk.Device, p_create_info: *const vk.Descriptor.Set.Layout.Create.Info) !@This() {
