...
pub const Image = enum(u64) {
    ...
    pub const Subresource = extern struct {
        ...
        pub const Layout = extern struct {
            pub fn get(device: vk.Device, image: vk.Image, p_subresource: *const vk.Image.Subresource) vk.Subresource.Layout {
                var layout: vk.Subresource.Layout = undefined;
                raw.prototypes.device.vkGetImageSubresourceLayout(device, image, p_subresource, &layout);
                return layout;
            }
        };
    ...
    pub const View = enum(u64) {
        ...
        pub fn create(device: vk.Device, p_create_info: *const vk.Image.View.Create.Info) !@This() {
    ...
    pub fn create(device: vk.Device, p_create_info: *const vk.Image.Create.Info) !@This() {
