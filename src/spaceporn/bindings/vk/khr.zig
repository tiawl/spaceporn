...
pub const NextImage = extern struct {
    pub fn acquire(device: vk.Device, swapchain: vk.KHR.Swapchain, timeout: u64, semaphore: vk.Semaphore, fence: vk.Fence) !u32 {
        var image_index: u32 = undefined;
        const result = raw.prototypes.device.vkAcquireNextImageKHR(device, swapchain, timeout, semaphore, fence, &image_index);
