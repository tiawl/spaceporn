...
pub const Context = struct {
    ...
    fn prepare_pane(self: *@This(), framebuffer: struct {
        ...
        if (!self.init_window) {
            const window_pos = imgui.Vec2{
                .x = 0.0,
                .y = 0.0,
            };
            const window_pivot = imgui.Vec2{
                .x = 0.0,
                .y = 0.0,
            };
    ...
    fn prepare_fps(_: @This(), allocator: *std.mem.Allocator, last_displayed_fps: *?std.time.Instant, fps: *f32) !void {
    ...
    pub fn prepare(self: *@This(), allocator: *std.mem.Allocator, last_displayed_fps: *?std.time.Instant, fps: *f32, framebuffer: struct {
        width: u32,
        height: u32,
    }, tweak_me: *Tweaker) !ImguiPrepare {
        imgui.vk.Frame.new();
