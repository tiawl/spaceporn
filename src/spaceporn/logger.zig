...
const Profile = enum(ProfileInt) {
    ...
    pub fn int(self: @This()) ProfileInt {
        return @intFromEnum(self);
    }
...
pub const Logger = struct {
    ...
    fn write(self: @This(), caller: [*:0]const u8, level: Level, event: ?Event, comptime format: []const u8, args: anytype) !void {
